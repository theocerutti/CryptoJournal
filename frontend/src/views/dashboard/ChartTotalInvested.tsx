...
export default function ChartTotalInvested() {
  ...
  const [currentTimeline, setCurrentTimeline] = useState(
    'YTD' as keyof typeof ChartTimeline
  );
  ...
  const lineChartOptionsTotalSpent = {
    ...
    tooltip: {
      ...
      custom: function ({ series, seriesIndex, dataPointIndex }: any) {
        setTooltipValue(series[seriesIndex][dataPointIndex]);
        return '';
      },
    },
    fill: {
  ...
  const updateTimeline = (timeline: keyof typeof ChartTimeline) => {
    ...
    <Card>
      <Flex justify='center'>
        <Menu>
          ...
          <MenuList>
            {Object.keys(ChartTimeline)
              .filter((v) => isNaN(Number(v)))
              .map((v) => v as keyof typeof ChartTimeline)
              .map((timeline) => (
                <MenuItem
      ...
      <Flex w='100%' flexDirection='row'>
        <Flex w='8%' justify='center' align='center'>
          ...
          >
            ...
            <StatNumber>{tooltipValue}</StatNumber>
        ...
        <Box minW='92%' minH='300px' mt='auto'>
          <div id='chart-timeline'>
            {/* @ts-ignore */}
            <ReactApexChart
              onMouseLeave={() => setTooltipValue(0)}
